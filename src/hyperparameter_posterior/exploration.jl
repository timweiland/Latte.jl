...
"""
function explore_hyperparameter_posterior(model::INLAModel, y, θ_star, mode_points, mode_logdensities;
    ...
    return HyperparameterExploration(θ_star, interpolation_θs, integration_indices, 
